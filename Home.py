...
st.title("Fr. Conceicao Rodrigues College of Engineering About Project")

st.image("img.png",width=500)

st.header("Project Guide: Professor Jayan Modi Sir ")
st.write("1.Aman Gupta 9752")
st.write("1.Aditya Gurav 9753")
st.write("1.Abdullah  9759")
