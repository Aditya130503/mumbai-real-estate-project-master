...
minimum_price = st.number_input("Enter Your Minimum Budget in Cr(40 lacs then 0.40)",value=0.3)
maximum_price = st.number_input("Enter Your Maximum Budget in Cr(40 lacs then 0.40)",value=1.0)
